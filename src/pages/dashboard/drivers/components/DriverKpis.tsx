import { driverKpis, type DriverKpi } from '@/mocks/drivers';

const toneClass: Record<DriverKpi['tone'], string> = {
...
const valueClass: Record<DriverKpi['tone'], string> = {
  neutral: 'text-foreground-950',
  accent: 'text-accent-700',
  secondary: 'text-secondary-700',
};

export default function DriverKpis() {
  return (
