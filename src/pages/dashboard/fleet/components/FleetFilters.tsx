...
type FleetFiltersProps = {
  ...
  onStatus: (s: TruckStatus | null) => void;
  search: string;
  onSearch: (s: string) => void;
  make: string;
  onMake: (m: string) => void;
  type: string;
    ...
    <div className="rounded-lg border border-background-200 bg-background-50 p-3">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-2 pt-2 border-t border-background-200">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <FilterSelect label="Make" icon="ri-car-line" options={makeOptions} value={make} onChange={onMake} />
          <FilterSelect label="Type" icon="ri-truck-line" options={typeOptions} value={type} onChange={onType} />
          <FilterSelect label="Base" icon="ri-building-4-line" options={baseOptions} value={base} onChange={onBase} />
        </div>
