...
export default function TerminalDetailPage() {
  ...
  if (!terminal) {
    return (
      <ModuleShell title="Terminal Details" description="Terminal details, availability, and pricing." icon="ri-building-4-line" subNav={sourcingNav}>
  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={() => navigate('/sourcing/terminals')}
